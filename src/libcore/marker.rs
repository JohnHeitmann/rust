...
///
/// [`PhantomData`]: ../../std/marker/struct.PhantomData.html
/// [`PhantomData<&'a T>`]: ../../std/marker/struct.PhantomData.html
/// [`PhantomData<*const T>`]: ../../std/marker/struct.PhantomData.html
/// [`PhantomData<T>`]: ../../std/marker/struct.PhantomData.html
#[lang = "phantom_data"]
#[stable(feature = "rust1", since = "1.0.0")]
...
///
/// [`Reflect`]: ../../std/marker/trait.Reflect.html
#[rustc_reflect_like]
